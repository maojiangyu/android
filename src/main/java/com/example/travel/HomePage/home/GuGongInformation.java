...
public class GuGongInformation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gugonginformation);
        init();
    }
    private void init(){
        btn1 = findViewById(R.id.gugong_information_return_btn);
        ShowBtn = findViewById(R.id.gugong_information_gonglve_btn);
        BuyBtn = findViewById(R.id.gugong_information_buy_btn);
        InformBtn = findViewById(R.id.gugong_information_tongzhi_btn);
        mScrollView = findViewById(R.id.gugong_scrollView);

        btn2 = findViewById(R.id.gugong1);
        btn3 = findViewById(R.id.gugong2);
        btn4 = findViewById(R.id.gugong3);
        btn2.setBackgroundResource(R.drawable.normal);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                GuGongInformation.this.finish();
            }
        });
