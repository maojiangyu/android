...
public class ZooInformation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zooinformation);
        init();
    }
    private void init(){
        btn1 = findViewById(R.id.zoo_information_return_btn);
        ShowBtn = findViewById(R.id.zoo_information_gonglve_btn);
        BuyBtn = findViewById(R.id.zoo_information_buy_btn);
        InformBtn = findViewById(R.id.zoo_information_tongzhi_btn);
        mScrollView = findViewById(R.id.zoo_ScrollView);

        btn2 = findViewById(R.id.zoo1);
        btn3 = findViewById(R.id.zoo2);
        btn4 = findViewById(R.id.zoo3);
        btn2.setBackgroundResource(R.drawable.normal);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ZooInformation.this.finish();
            }
        });
