...
public class LinYinInformation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.linyininformation);
        init();
    }
    private void init(){
        btn1 = findViewById(R.id.lingyin_information_return_btn);
        ShowBtn = findViewById(R.id.lingyin_information_gonglve_btn);
        BuyBtn = findViewById(R.id.lingyin_information_buy_btn);
        InformBtn = findViewById(R.id.lingyin_information_tongzhi_btn);
        mScrollView = findViewById(R.id.lingyin_scrollView);

        btn2 = findViewById(R.id.lingyin1);
        btn3 = findViewById(R.id.lingyin2);
        btn4 = findViewById(R.id.lingyin3);
