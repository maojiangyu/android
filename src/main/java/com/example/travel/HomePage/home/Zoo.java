...
public class Zoo extends Activity {
    ...
    private int[] ImageIds = new int[]{
            R.drawable.dongwuyuan1,R.drawable.dongwuyuan2, R.drawable.dongwuyuan3
    };
    //imageView的集合
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        guide.setAdapter(new Zoo.GuideAdapter());//设置数据

        initTxs();//下面的初始化方法
        RecyclerView recyclerView = findViewById(R.id.Zoo_recyclerView2);//找到RecyclerView控件
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);//布局管理器
        recyclerView.setLayoutManager(layoutManager);
        NearAdapter adapter = new NearAdapter(txList, Zoo.this, new NearAdapter.OnItemClickListener() {
            //@Override
    ...
    private void init(){
        mBtn = findViewById(R.id.ZooMapBtn);
        mBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Zoo.this,ZooMap.class));
            }
        });
    }

    private void initViews() {
        guide = (ViewPager) findViewById(R.id.guide_zoo);
        return1 = findViewById(R.id.btn_zoo_return);
    ...
    public void OnClickToZooInformation(View view){
        startActivity(new Intent(Zoo.this,ZooInformation.class));
    }
}
