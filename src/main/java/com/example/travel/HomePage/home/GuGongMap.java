...
public class GuGongMap extends Activity {
    ...
    protected LatLng target=new LatLng(39.924091,116.403414);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gugongmap);
        mMapView = (MapView) findViewById(R.id.map_GuGong);
    ...
    private void init(){
        ...
        mbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                GuGongMap.this.finish();
            }
        });

        btn_food = (Button) findViewById(R.id.btn_GuGong_food);
        btn_scenery = findViewById(R.id.btn_GuGong_scenery);
        btn_hotel = findViewById(R.id.btn_GuGong_hotel);
        btn_close3 = (Button) findViewById(R.id.GuGong_map_close3) ;
        btn_close2 = (Button) findViewById(R.id.GuGong_map_close2) ;
        btn_close1 = (Button) findViewById(R.id.GuGong_map_close1) ;
        mBehavior_food = findViewById(R.id.GuGong_bottomSheet1);
        mBehavior_scenery = findViewById(R.id.GuGong_bottomSheet2);
        mBehavior_hotel = findViewById(R.id.GuGong_bottomSheet3);

        RecyclerView recyclerView_food = (RecyclerView) mBehavior_food.findViewById(R.id.GuGong_map_recyclerview1);
        mBottomSheetBehavior_food = BottomSheetBehavior.from(mBehavior_food);

        RecyclerView recyclerView_scenery = (RecyclerView) mBehavior_scenery.findViewById(R.id.GuGong_map_recyclerview2);
        mBottomSheetBehavior_scenery = BottomSheetBehavior.from(mBehavior_scenery);

        RecyclerView recyclerView_hotel = (RecyclerView) mBehavior_hotel.findViewById(R.id.GuGong_map_recyclerview3);
    ...
    public List<Item> createFoodItems() {
        ...
        items.add(new Item(R.drawable.juqi, "局气","西单  烤鸭"));
        items.add(new Item(R.drawable.bingjiao, "故宫冰窖餐厅","王府井/东单  快餐简食"));
        items.add(new Item(R.drawable.siji, "四季民福烤鸭店","烤鸭"));
        items.add(new Item(R.drawable.litang, "小吊梨汤","王府井/东单  京菜"));
        return items;
    }

    public List<Item> createSceneryItems() {
        ArrayList<Item> items = new ArrayList<>();
        items.add(new Item(R.drawable.zhongbiao, "故宫钟表馆","东城区  展馆展览"));
        items.add(new Item(R.drawable.maozhuxi, "北京毛主席纪念堂","王府井/东单  名胜古迹"));
        items.add(new Item(R.drawable.zhenbao, "故宫珍宝馆","王府井/东单  展馆展览"));
        items.add(new Item(R.drawable.gongwangfu, "恭王府","后海/什刹海  名胜古迹"));
        return items;
    }

    public List<Item> createHotelItems() {
        ArrayList<Item> items = new ArrayList<>();
        items.add(new Item(R.drawable.jidu, "北京都季商旅酒店","舒适性"));
        items.add(new Item(R.drawable.baijie, "国瑞百捷酒店","经济型"));
        items.add(new Item(R.drawable.tianci, "天赐庭院酒店","经济型"));
        return items;
    }
