...
import com.example.travel.DisplayUtil;
import com.example.travel.R;

public class XiXiInformation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xixiinformation);
        init();
    }
    private void init(){
        btn1 = findViewById(R.id.xixi_information_return_btn);
        ShowBtn = findViewById(R.id.xixi_information_gonglve_btn);
        BuyBtn = findViewById(R.id.xixi_information_buy_btn);
        InformBtn = findViewById(R.id.xixi_information_tongzhi_btn);
        mScrollView = findViewById(R.id.xixi_scrollView);

        btn2 = findViewById(R.id.xixi1);
        btn3 = findViewById(R.id.xixi2);
        btn4 = findViewById(R.id.xixi3);

        btn2.setBackgroundResource(R.drawable.normal);
        btn1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                XiXiInformation.this.finish();
            }
        });
