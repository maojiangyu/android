...
public class ZooMap extends Activity {
    ...
    protected LatLng target=new LatLng(30.160607,119.99203);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMapView = (MapView) findViewById(R.id.map_Zoo);
    ...
    private void init(){
        mbutton = findViewById(R.id.Zoo_map_return);
        ...
        btn_food = (Button) findViewById(R.id.btn_Zoo_food);
        btn_scenery = findViewById(R.id.btn_Zoo_scenery);
        btn_hotel = findViewById(R.id.btn_Zoo_hotel);
        btn_close3 = (Button) findViewById(R.id.Zoo_map_close3) ;
        btn_close2 = (Button) findViewById(R.id.Zoo_map_close2) ;
        btn_close1 = (Button) findViewById(R.id.Zoo_map_close1) ;
        mBehavior_food = findViewById(R.id.Zoo_bottomSheet1);
        mBehavior_scenery = findViewById(R.id.Zoo_bottomSheet2);
        mBehavior_hotel = findViewById(R.id.Zoo_bottomSheet3);

        RecyclerView recyclerView_food = (RecyclerView) mBehavior_food.findViewById(R.id.Zoo_map_recyclerview1);
        mBottomSheetBehavior_food = BottomSheetBehavior.from(mBehavior_food);

        RecyclerView recyclerView_scenery = (RecyclerView) mBehavior_scenery.findViewById(R.id.Zoo_map_recyclerview2);
        mBottomSheetBehavior_scenery = BottomSheetBehavior.from(mBehavior_scenery);

        RecyclerView recyclerView_hotel = (RecyclerView) mBehavior_hotel.findViewById(R.id.Zoo_map_recyclerview3);
    ...
    public List<Item> createFoodItems() {
        ...
        items.add(new Item(R.drawable.xixibieyuan, "西溪别院","西溪  私房菜"));
        items.add(new Item(R.drawable.nongtaoli, "弄堂里","西溪  浙菜"));
        items.add(new Item(R.drawable.waipojia, "外婆家","西溪 浙菜"));
        items.add(new Item(R.drawable.xinrongji, "新荣记","西溪 苏浙菜"));
        return items;
    }
    ...
    public List<Item> createSceneryItems() {
        ...
        items.add(new Item(R.drawable.lingyintitle, "灵隐寺","灵隐寺/白乐桥"));
