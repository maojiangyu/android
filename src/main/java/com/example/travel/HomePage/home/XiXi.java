...
public class XiXi extends Activity{
    private ViewPager guide;
    //引导页图片ID数组
    private int[] ImageIds = new int[]{
            R.drawable.xixishidi,R.drawable.xixishidi2,R.drawable.xixishidi3
            };
    //imageView的集合
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xihushidi);
        ...
        initTxs();//下面的初始化方法
        RecyclerView recyclerView = findViewById(R.id.XiXi_recyclerView2);//找到RecyclerView控件
        LinearLayoutManager layoutManager = new LinearLayoutManager(this);//布局管理器
        recyclerView.setLayoutManager(layoutManager);
        NearAdapter adapter = new NearAdapter(txList, XiXi.this, new NearAdapter.OnItemClickListener() {
            //@Override
    ...
    private void init(){
        mBtn = findViewById(R.id.XiXiMapBtn);
        mBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(XiXi.this, XiXiMap.class));
            }
        });
    }
    ...
    private void initTxs() {
        ...
        txList.add(c);//加入到链表
        NearItem d = new NearItem("雷锋塔景区", R.drawable.leifengta,"      8.8km","4.2","千古佳话 永世流传");
        txList.add(d);//加入到链表
    }

    public void OnClickToXiXiInformation(View view){
        startActivity(new Intent(XiXi.this,XiXiInformation.class));
    }
